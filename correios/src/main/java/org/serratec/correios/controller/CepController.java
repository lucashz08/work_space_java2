...
public class CepController {
	...
	@GetMapping("")
	public List<Cep> getTodos(@RequestParam Map<String, String> parametros /*, @RequestHeader(value = "Segredo") String token*/) { // cria um token pelo header // pega o valores por query string ex:
																				// ?cpf=25957005
